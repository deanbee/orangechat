		...
		$.each(data.items, function(i,item){
			if (item)	{ // fix strange ie bug
				...
				if (item.s == 2) {
                    ...
                    if (windowFocus == false) {
                    $("#chatbox_"+chatboxtitle+" .chatboxcontent").append('<div hidden="hidden"><audio controls="" autoplay=""><source src="<?php echo base() ?>sounds/alert.ogg" type="audio/ogg"><source src="<?php echo base() ?>sounds/alert.mp3" type="audio/mp3"></audio></div>');
                    }
				}
